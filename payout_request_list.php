                                                    ...
                                                    <div class="modal-body">
                                                        <form class="forms-sample" id="payform" name="payform">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="hidden" class="form-control" id="payid<?php 
                                                                    echo $row['prid']; ?>" name="payid<?php 
                                                                    echo $row['prid']; ?>"
                                                                    value="<?php echo $row['prid']; ?>">
                                                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive" id="datagrid">
                                <table id="dataTableExample" class="table table-hover table-bordered table-striped">
                                    ...
                                    $query = "SELECT * FROM payment_req where status = 'pay' ORDER BY prid DESC";  
                                    $select_result = mysqli_query($connection, $query);
                                    //count row > 0
                                    if(mysqli_num_rows($select_result) > 0){
                                        while($row = mysqli_fetch_array($select_result)){      
