...
$id = $_GET['id'];
$i=0; 
  $squery = "SELECT * FROM carmodel WHERE id=$id";  
...
<div class="page-content">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">CARMODEL EDIT</h4>
        </div>
    ...
    <div class="row">
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Car Model info</h6>
                    <form class="forms-sample" id="frmsetup" name="frmsetup" method="post" action="carmodel_update.php">

                        <div class="mb-3">
                            <label for="modelname" class="form-label">Name</label>
                            <input type="text" class="form-control" id="modelname" name="modelname"
                                value="<?php echo $srow['modelname'];?>">
                    ...
                    <a class="btn btn-success me-2" href="model.php">Back</a>
                </div>
            </div>
        </div>
    </div>
...
function addtruck(r, t) {
    ...
    $("#truckdiv ul").append('<li class="list-group-item d-flex justify-content-between text-right">' + pf + '-' + rg +
        '<input type="hidden" id="truck' + rid + '" name="truck' + rid + '" value="' + t + '"></li>');
    rid++;
}
