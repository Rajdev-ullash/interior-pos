...
?>
                       ...
                       <td><?php echo $row['cname'];?></td>
                        <td><?php echo $row['des'];?></td>
                         <td><?php echo $row['unitprice'];?></td>
                          ...
                          <td><?php echo $tt; ?></td>                    
                         <td><a class="btn btn-primary btn-xs me-2" href="invoice_print.php?ino=<?php echo $row['invoiceno'];?>" target="_blank">Print invoice</a><a class="btn btn-primary btn-xs me-2" href="challan_print.php?ino=<?php echo $row['invoiceno'];?>" target="_blank">Print challan</a></td>
                      </tr>
                      <?php
                      $i++;
                      }
  ...
  function showreport(){
    var fd = $('#fdate').val();
    var td = $('#tdate').val();
    window.location.replace("sales_view.php?f="+fd+"&t="+td);
  }
  </script>
