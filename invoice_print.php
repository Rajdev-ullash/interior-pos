  ...
  <!-- PROCESS SECTION -->
            ...
            <?php
             ...
             $cname = stripslashes($row1["cname"]);
              $address = $row1["address"];
               ...
               echo "<td width='25%' style='text-align:center;border: 1px solid;'><strong>INVOICE NO:</strong>".$row["invoiceno"]."<td>";
            ...
            $i=1;
             ...
             while($row = mysqli_fetch_array($detailresult)) {
              ...
              echo "</tr></table>";
              echo '<p style="text-align:left;"><strong>In Word:  </strong> '.numberTowords($gtotal).' Only</p>'; 
