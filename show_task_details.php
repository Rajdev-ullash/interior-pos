...
$query = "SELECT * FROM project_task WHERE taskid = $id";
//execute query
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mt-3 align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="text" class="form-control" id="tname" name="tname" placeholder="Task Name"
                                data-input value="<?php echo $row['taskname']; ?>">
                    ...
                    <div class="row mt-3 align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="text" class="form-control" id="description" name="description"
                                placeholder="Description" data-input value="<?php echo $row['description']; ?>">
                    ...
                    <div class="row mt-3 align-items-center">
                        ...
                        <div class="col-md-11">
                            <select class="form-select mt-2" id="manager" name="manager">
                                <?php
                                ...
                                <option value="<?php echo $crow['id']; ?>"
                                    <?php if($row['assignedto'] == $crow['id']){ echo "selected"; } ?>>
                    ...
                    <div class="row mt-3 align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="date" class="form-control" id="sdate" name="sdate" data-input
                    ...
                    <div class="row mt-3 align-items-center">
                        ...
                        <div class="col-md-11">
                            <input type="date" class="form-control" id="edate" name="edate" data-input
                    ...
                    <div class="row mt-3 align-items-center">
                        ...
                        <div class="col-md-11">
                            <select class="form-select mt-2" id="status" name="status">
                                ...
                                <option value="1" <?php if($row['status'] == 1){ echo "selected"; } ?>>Done</option>
                            </select>
                        </div>
