...
?>
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">CLEARED LC</h4>
          </div>
      ...
      <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">LC LIST</h6>
                <div class="table-responsive" id="datagrid">
                  <table id="dataTableExample" class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $i=0;
                      $thisid=0;
                      $query = "SELECT * FROM lc WHERE status='approved' ORDER BY lcdate DESC";  
                      $select_result = mysqli_query($connection, $query);  
                      while($row = mysqli_fetch_array($select_result)){     
                      $thisid=$row['lcid'];
                      $totalq="SELECT SUM(amount) AS totalcost FROM lc_cost WHERE lcid=$thisid";
                      ...
                      <tr>
                       ...
                       <td><?php echo $row['lcdate'];?></td>
                       <td><?php echo $row['supplier'];?></td>
                        <td><?php echo $row['bank'];?></td>
                         <td><?php echo $row['lcamount'];?></td>
                          <td><?php echo $row['actualamount'];?></td>
                           <td><?php echo $trow['totalcost'];?></td>
                       <td><a class="btn btn-primary btn-xs" href="carstock_receive.php?id=<?php echo $row['lcid'];?>">Receive cars</a></td>
                      </tr>
                      <?php
                      $i++;
                      }
