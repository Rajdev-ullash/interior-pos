                  ...
                  <table id="dataTableExample" class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                       ...
                       <td><a class="btn btn-primary btn-xs me-2" href="supplier_edit.php?id=<?php echo $row['sid'];?>">Edit</a><a class="btn btn-primary btn-xs" href="supplier_ledger.php?sid=<?php echo $row['sid'];?>">Ledger</a></td>
                      </tr>
                      <?php
                      }
                      ?>
