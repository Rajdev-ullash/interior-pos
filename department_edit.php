...
$id = $_GET['id'];
$i=0; 
  $squery = "SELECT * FROM expensehead WHERE xid=$id";  
...
?>
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">LC COST HEAD EDIT</h4>
          </div>
      ...
      <div class="row">
          <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">LC COST HEAD</h6>
                   <form class="forms-sample" id="frmsetup" name="frmsetup" method="post" action="costhead_update.php">

                  <div class="mb-3">
                    <label for="cartype" class="form-label">Head Name</label>
                    <input type="text" class="form-control" id="xname" name="xname" value="<?php echo $srow['xname'];?>">
                     <input type="hidden" class="form-control" id="xid" name="xid" value="<?php echo $srow['xid'];?>">
                  </div>
                  ...
                  <a class="btn btn-success me-2" href="type.php">Back</a>
              </div>
            </div>
          </div>
        </div>
