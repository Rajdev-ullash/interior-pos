...
?>
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">LC ON PROCESS</h4>
          </div>
                ...
                <div class="table-responsive" id="datagrid">
                  <table id="dataTableExample" class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                      $i=0;
                      $query = "SELECT * FROM lc WHERE status='new' ORDER BY lcdate DESC";  
                      ...
                      <tr>
                       ...
                       <td><a class="btn btn-primary btn-xs" href="lc_edit.php?id=<?php echo $row['lcid'];?>">Detail</a></td>
                      </tr>
                      <?php
                      $i++;
                      }
