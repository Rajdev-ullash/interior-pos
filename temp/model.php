...
?>
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">CAR MODEL</h4>
          </div>
                  ...
                  <table id="dataTableExample" class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                       ...
                       <td><a class="btn btn-primary btn-xs" href="supplier_edit.php?id=<?php echo $row['id'];?>">Edit</a></td>
                      </tr>
                      <?php
                      }
                      ?>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">NEW CAR MODEL</h5>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="modelname" name="modelname" placeholder="Car name">
                  </div>
