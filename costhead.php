...
?>
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">LC COST HEAD</h4>
          </div>
      ...
      <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">Cost Head List</h6>
                <div class="table-responsive" id="datagrid">
                  <table id="dataTableExample" class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                      $query = "SELECT * FROM expensehead ORDER BY xname DESC";  
                      $select_result = mysqli_query($connection, $query);  
                      while($row = mysqli_fetch_array($select_result)){      
                      ?>
                      <tr>
                       <td><?php echo $row['xname'];?></td>
                       <td><a class="btn btn-primary btn-xs" href="costhead_edit.php?id=<?php echo $row['xid'];?>">Edit</a></td>
                      </tr>
                      <?php
                      }
                      ?>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">NEW COST HEAD</h5>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="xname" name="xname" placeholder="Car Type">
                  </div>
