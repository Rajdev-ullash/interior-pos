...
$sid = $_GET['id'];
$i=0; 
  $squery = "SELECT * FROM supplier WHERE sid=$sid";  
...
?>
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">SUPPLIER INFO EDIT</h4>
          </div>
            ...
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">Supplier info</h6>
                   <form class="forms-sample" id="frmsetup" name="frmsetup" method="post" action="supplier_update.php">

                  <div class="mb-3">
                    <label for="sname" class="form-label">Name</label>
                    <input type="text" class="form-control" id="sname" name="sname" value="<?php echo $srow['sname'];?>">
                     <input type="hidden" class="form-control" id="sid" name="sid" value="<?php echo $srow['sid'];?>">
                  </div>

                  <div class="mb-3">
                    <label for="addr" class="form-label">Address</label>
                    <input type="text" class="form-control" id="addr" name="addr" value="<?php echo $srow['saddress'];?>">
                  </div>
                    <div class="mb-3">
                  ...
                  <a class="btn btn-success me-2" href="supplier.php">Back</a>
              </div>
            </div>
          </div>
        </div>
